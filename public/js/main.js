...
const products = [
  ...
  },
  {
    ...
    name: 'Кінець вистави',
    tag: '🎭 ТРАНСФОРМАЦІЯ',
    shortDesc: 'Звільнись від масок і почни жити справжнім життям.',
    fullDesc: `
      <p><strong>MASK_X</strong> – це система для виходу з ролей, які ти граєш, і повернення до справжньої себе.</p>
      <p>🎭 У цьому матеріалі ти дізнаєшся:</p>
      <ul>
        <li>➕ чому ти носиш маски навіть перед собою</li>
        <li>➕ як розпізнати свої справжні бажання</li>
        <li>➕ як перестати боятися осуду і бути вразливим</li>
        <li>➕ як зробити крок до автентичності вже сьогодні</li>
      </ul>
      <p>Це практичний посібник, який допоможе тобі скинути зайве і залишити тільки те, що важливо.</p>
    `,
    price: '200 грн',
    priceCrypto: '≈ 5$',
    image: 'img/mask.png'
  ...
  {
  id: 5,
  name: 'Внутрішній суддя',
  tag: '🚀 СКОРО',
  shortDesc: 'Новий продукт про самооцінку – стежте за анонсами!',
  fullDesc: `
    <p>Ти прокидаєшся і ще до кави надягаєш маску. Зручну. Сильну. Ту, яку навчився носити ще в дитинстві. Але коли ти востаннє був собою?</p>
    <p>🎭 У цьому матеріалі ти зрозумієш:</p>
    <ul>
      <li>➕ чому ти носиш маски навіть перед собою</li>
      <li>➕ як розпізнати свої справжні бажання</li>
      <li>➕ як перестати грати роль і повернути собі справжнє обличчя</li>
      <li>➕ як зробити крок до автентичності вже сьогодні</li>
    </ul>
    <p>Це практичний посібник, який допоможе тобі скинути зайве і залишити тільки те, що важливо.</p>
    <p>⚠️ Більшість людей живуть життям, яке їм не належить. Ти можеш змінити це за один вечір.</p>
  `,
  price: 'Ціна буде анонсована',
  priceCrypto: '',
  image: 'img/value_x.png',
  isSoon: true
}
];
