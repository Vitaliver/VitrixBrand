...
const products = [
  ...
  },
  {
    ...
    fullDesc: `
      <p><strong>VALUE_X</strong> – це система роботи з самооцінкою та внутрішнім критиком.</p>
      <p>Над цим я працюю прямо зараз, щоб дати тобі інструменти для:</p>
      <ul>
        <li>➕ прийняття себе без зайвої критики</li>
        <li>➕ побудови здорової самооцінки</li>
        <li>➕ припинення порівнянь з іншими</li>
        <li>➕ віри у власні сили</li>
      </ul>
